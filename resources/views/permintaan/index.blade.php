                ...
                <form action="" method="get" class="flex gap-4">
                    <select name="alasan_id" class="select">
                        ...
                        @foreach ($alasans as $alasan)
                            <option value="{{ $alasan->id }}" @selected(request('alasan_id') == $alasan->id)>{{ $alasan->label }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <button type="submit" class="btn btn-square btn-primary"><i
                            class="ti ti-search text-xl"></i></button>
                </form>
            </div>
